    ...
    public class CompilerCache : ICompilerCache
    {
            ...
            foreach (var viewCollection in razorFileInfoCollections)
            {
                ...
                foreach (var fileInfo in viewCollection.FileInfos)
                {
                    ...
                    _cache.Set(
                        normalizedPath,
                        cacheEntry,
                        GetCacheEntryOptions(normalizedPath, fileInfo.RelativePath));
                                           ...
                                           Func<RelativeFileInfo, CompilationResult> compile)
        {
            ...
            var cacheEntry = _cache.Set<CompilerCacheEntry>(
                normalizedPath,
                compilerCacheEntry,
                GetCacheEntryOptions(normalizedPath, compilerCacheEntry.RelativePath));
        ...
        private CacheEntryOptions GetCacheEntryOptions(string normalizedPath, string relativePath)
        {
